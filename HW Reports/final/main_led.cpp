...
static void heating()
{
    byte mask_init = 0b00000011;
    byte mask_rotate = 0b10000001;
    while (1) {
        write_leds(mask_init | mask_rotate);
        mask_rotate = rright(mask_rotate, 1, 8);
        __delay_cycles(1000000);
    }
}
...
static void cooling()
{
    byte mask_init = 0b11000000;
    byte mask_rotate = 0b10000001;
    while (1) {
        write_leds(mask_init | mask_rotate);
        mask_rotate = rleft(mask_rotate, 1, 8);
        __delay_cycles(1000000);
    }
}
